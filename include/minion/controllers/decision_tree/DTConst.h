...
namespace DTConst {
    enum Facts {
        ...
        FACT_BOUNDARY_LEFT, FACT_BOUNDARY_FRONT, FACT_BOUNDARY_RIGHT, FACT_FOOD_LEFT, FACT_FOOD_FRONT,
        FACT_FOOD_RIGHT, FACT_POISON_LEFT, FACT_POISON_FRONT, FACT_POISON_RIGHT, FACT_SOMETHING_FAR_BEHIND,
        FACT_SOMETHING_CLOSE_BEHIND, FACT_HEALTHY, FACT_UNHEALTHY, FACT_MOVING_FAST, FACT_MOVING_SLOW,
